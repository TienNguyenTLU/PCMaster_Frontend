...
const SPECS_BY_CATEGORY: Record<string, SpecField[]> = {
  ...
  laptop: [
    { key: 'cpu', label: 'Bộ vi xử lý (CPU)', type: 'text', placeholder: 'AMD Ryzen 5-5625U...' },
    { key: 'ram', label: 'Bộ nhớ RAM', type: 'text', placeholder: '8GB (1x8GB) DDR4...' },
    { key: 'ram_slots', label: 'Số khe cắm RAM', type: 'number', placeholder: '2' },
    { key: 'ssd', label: 'Dung lượng ổ cứng', type: 'text', placeholder: '512GB...' },
    { key: 'ssd_slots', label: 'Số khe cắm SSD', type: 'number', placeholder: '2' },
    { key: 'ssd_type', label: 'Chuẩn SSD', type: 'text', placeholder: 'M.2 NVMe PCIe' },
    { key: 'vga', label: 'Card đồ họa (VGA)', type: 'text', placeholder: 'AMD Radeon Graphics...' },
    { key: 'screen_size', label: 'Kích thước màn hình (inch)', type: 'number', placeholder: '15.6' },
    { key: 'refresh_rate', label: 'Tần số quét (Hz)', type: 'number', placeholder: '60' },
    { key: 'screen_tech', label: 'Công nghệ màn hình', type: 'text', placeholder: 'Tấm nền IPS...' },
    { key: 'ports', label: 'Cổng kết nối', type: 'text', placeholder: '1x USB Type-C, HDMI...' },
    { key: 'material', label: 'Chất liệu vỏ', type: 'text', placeholder: 'Nhựa, Nhôm...' },
    { key: 'connectivity', label: 'Kết nối không dây', type: 'text', placeholder: '802.11ac + BT...' },
    { key: 'os', label: 'Hệ điều hành', type: 'text', placeholder: 'Windows 11 Home SL...' },
    { key: 'weight', label: 'Trọng lượng (kg)', type: 'number', placeholder: '1.45' },
    { key: 'webcam', label: 'Webcam', type: 'text', placeholder: 'HD (30fps@720p)...' },
    { key: 'battery', label: 'Pin & Bộ sạc', type: 'text', placeholder: '58Wh 3-cell...' },
    { key: 'dimensions', label: 'Kích thước máy', type: 'text', placeholder: '360.66 x 234.8 x 16.95 mm' },
    { key: 'color', label: 'Màu sắc', type: 'text', placeholder: 'Silver (Bạc)...' },
    { key: 'brightness_cdm2', label: 'Độ sáng (cd/m2)', type: 'number', placeholder: '250' },
    { key: 'audio_tech', label: 'Công nghệ âm thanh', type: 'text', placeholder: 'Stereo Speakers, Dolby Audio...' },
    { key: 'touchscreen', label: 'Màn hình cảm ứng', type: 'boolean' },
    { key: 'has_numpad', label: 'Bàn phím số (Numpad)', type: 'boolean' },
    { key: 'is_two_in_one', label: 'Laptop 2-in-1 (Xoay gập)', type: 'boolean' },
    { key: 'screen_finish', label: 'Bề mặt màn hình', type: 'text', placeholder: 'Anti-glare, gương, nhám...' },
    { key: 'resolution', label: 'Độ phân giải', type: 'text', placeholder: '1920x1080...' },
    { key: 'color_accuracy', label: 'Độ chuẩn màu', type: 'text', placeholder: '45% NTSC, 100% sRGB...' },
    { key: 'intended_use', label: 'Mục đích sử dụng', type: 'multiselect', options: ['Văn phòng', 'Chơi game', 'Đồ họa', 'Workstation / Server', 'Học tập'] },
    { key: 'technologies', label: 'Công nghệ tích hợp', type: 'text', placeholder: 'Intel Hyper-Threading, AMD 3D V-Cache...' },
  ],
};
