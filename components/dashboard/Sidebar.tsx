  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-[#0f172a] flex flex-col z-40 transition-transform">
      ...
      <div className="h-16 flex items-center px-6 border-b border-[rgba(255,255,255,0.1)]">
        <Link
          href="/dashboard"
          className="text-white text-[22px] font-black tracking-tight uppercase flex items-baseline gap-1.5"
          style={{ fontFamily: "Inter, sans-serif" }}
        >
          PC<span className="text-[#0058be]">Master</span>{" "}
          <span className="text-[#0b82d2] text-[12px] uppercase tracking-[1px] font-normal normal-case">
