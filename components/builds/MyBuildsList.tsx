      ...
      <div className="flex items-center justify-between border-b border-slate-200 pb-3">
        <div>
          ...
          <p className="text-[#64748b] text-[13px] mt-0.5">
            Tải lại cấu hình cũ để tiếp tục căn chỉnh hoặc đặt mua.
          </p>
        </div>
        <button
      ...
      {loadingMyBuilds ? (
        ...
        <div className="bg-white rounded-[24px] border border-[#e8ecf2] p-12 text-center flex flex-col items-center gap-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[#64748b] text-[13px] mt-1">
              Đăng nhập tài khoản khách hàng để xem các cấu hình PC đã tự thiết
              kế trước đó.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-[24px] border border-[#e8ecf2] p-12 text-center flex flex-col items-center gap-4 shadow-sm">
          ...
          <div>
            ...
            <p className="text-[#64748b] text-[13px] mt-1">
              Tự tay lắp ráp các linh kiện tương thích bên tab **Thiết kế PC**
              và lưu lại.
            </p>
          </div>
          <button
          ...
          {myBuilds.map((b) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-[#0f172a] font-bold text-[16px] leading-snug group-hover/card:text-[#0058be] transition-colors">
                    {b.name}
                  </h4>
                  <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 mt-2 text-[11px] text-[#64748b] font-semibold">
                    ...
                    {b.totalPower > 0 && (
                      <span className="bg-amber-50 text-amber-700 border border-amber-100 px-2 py-0.5 rounded-[6px]">
                        TDP: {b.totalPower}W
                      </span>
                    )}
                  </div>
