      ...
      <div className="max-w-[1400px] mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-[13.5px] leading-relaxed text-[#64748b]">
            Kiến tạo các cấu hình PC hiệu năng đỉnh cao, được tinh chỉnh chuyên
            biệt dành cho Nhà sáng tạo nội dung, Game thủ chuyên nghiệp và Doanh
            nghiệp.
          </p>
          ...
          <ul className="flex flex-col gap-3">
            {[
              ...
              { label: "Card đồ họa (VGA)", href: "/explore?category=vga" },
              {
                ...
                href: "/explore?category=mainboard",
              },
        ...
        <div className="flex flex-col gap-6">
          ...
          <p className="text-[13px] text-[#64748b] leading-relaxed">
            Đăng ký để cập nhật các cấu hình mới nhất, ưu đãi độc quyền và xu
            hướng công nghệ hàng tuần.
          </p>
