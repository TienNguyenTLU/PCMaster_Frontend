...
const footerLinks = {
  'LINH KIỆN': ['CẤU HÌNH PC', 'VI XỬ LÝ', 'CARD ĐỒ HỌA'],
  'HỖ TRỢ': ['DỊCH VỤ KHÁCH HÀNG', 'CHÍNH SÁCH BẢO HÀNH', 'VẬN CHUYỂN & GIAO HÀNG'],
    ...
    <footer className="bg-[#f1f5f9] w-full">
      <div className="max-w-[1536px] mx-auto px-12 py-16 grid grid-cols-4 gap-8">
        ...
        <div className="flex flex-col gap-[22.8px]">
          ...
          <p
            ...
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            Thiết kế các cấu hình PC hiệu năng cao chuyên biệt cho nhà sáng tạo,
            game thủ và chuyên gia công nghệ.
          </p>
        ...
        {Object.entries(footerLinks).map(([category, items]) => (
          <div key={category} className="flex flex-col gap-6">
            <p
              className="text-[#0f172a] text-[12px] tracking-[1.2px] uppercase font-semibold"
              style={{ fontFamily: 'Inter, sans-serif' }}
            >
              {category}
            </p>
      ...
      <div className="max-w-[1536px] mx-auto px-12 pb-16">
        <div className="flex flex-col gap-4 max-w-[260px]">
          <p
            className="text-[#0f172a] text-[16px] leading-[24px] font-semibold"
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            Đăng ký nhận tin
          </p>
          ...
          <p
            ...
            style={{ fontFamily: 'Inter, sans-serif' }}
          >
            © 2024 PCMaster Precision Architect. Tất cả các quyền được bảo lưu.
          </p>
        </div>
      </div>
      ...
      <div className="border-t border-[#e2e8f0] px-12 py-8">
        <p
          ...
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
          © 2024 PCMASTER PRECISION ARCHITECT. BẢO LƯU MỌI QUYỀN.
        </p>
      </div>
    </footer>
  );
