...
const SPECS_BY_CATEGORY: Record<string, SpecFilterDef[]> = {
  ...
  cooler: [
    {
      ...
      type: "select",
      options: ["Tản nhiệt nước", "Tản nhiệt khí"],
    },
    {
  ...
  cpu: [
    ...
    },
    {
      ...
      label: "Socket",
      type: "select",
      options: ["AM5", "AM4", "LGA1851", "LGA1700", "LGA1200"],
    },
    {
      key: "cores",
      label: "Số nhân",
      type: "select",
      options: ["2", "4", "6", "8", "10", "12", "14", "16", "20", "24", "32"],
    },
    {
      key: "threads",
      label: "Số luồng",
      type: "select",
      options: ["2", "4", "8", "12", "16", "20", "24", "28", "32", "48", "64"],
    },
    {
      key: "base_clock_ghz",
  ...
  fan: [
    ...
    },
    {
      ...
      label: "Chuẩn cắm",
      type: "select",
      options: ["PWM (4-pin)", "ARGB", "PWM (4-pin) ARGB"],
    },
    {
      key: "bearing_type",
      label: "Loại trục",
  ...
  monitor: [
    {
      ...
      type: "select",
      options: ["24 inch", "27 inch", "32 inch", "34 inch"],
    },
    {
      key: "resolution",
      label: "Độ phân giải",
    ...
    },
    {
      ...
      label: "Tần số quét",
      type: "select",
      options: ["120 Hz", "144 Hz", "165 Hz", "180 Hz", "240 Hz"],
    },
    {
      key: "panel_type",
      label: "Loại tấm nền",
  ...
  psu: [
    {
      ...
      label: "Công suất (W)",
      type: "select",
      options: ["500", "650", "750", "850", "1000", "1200", "1600"],
    },
    {
  ...
  ram: [
    ...
    },
    {
      ...
      type: "select",
      options: ["3200", "3600", "5600", "6000", "6600"],
    },
    {
      key: "latency_cl",
      label: "CAS Latency (CL)",
      type: "select",
      options: ["16", "18", "30", "32", "36", "40"],
    },
    { key: "has_rgb", label: "Có RGB", type: "boolean" },
  ],
  ssd: [
    {
      ...
      label: "Dung lượng (GB)",
      type: "select",
      options: ["240", "250", "256", "500", "512", "1000", "2000"],
    },
    {
      key: "ssd_type",
      label: "Phân loại",
  ...
  vga: [
    {
      key: "vga_series",
      label: "Dòng sản phẩm (VGA Series)",
      type: "select",
      options: [
        "RTX 50 Series",
        "RTX 40 Series",
    ...
    {
      key: "graphics_processor",
      label: "Thương hiệu GPU",
      type: "select",
      options: ["NVIDIA", "AMD"],
    },
    {
  ...
  laptop: [
    {
      ...
      label: "Kích thước màn hình",
      type: "select",
      options: ["13.3 inch", "14 inch", "15.6 inch", "16 inch"],
    },
    {
      key: "refresh_rate",
      label: "Tần số quét",
...
function getSpecFiltersForCategory(catName: string): SpecFilterDef[] {
  ...
  if (slug.includes("cool") || slug.includes("tan nhiet"))
...
function SpecRangeSlider({
  ...
  const [minVal, maxVal] = value ? value.split(",").map(Number) : [min, max];
    ...
    <div className="flex flex-col gap-4 px-1 py-1">
      ...
      <div className="flex items-center gap-2">
        <div className="flex-1 relative">
          ...
          />
          <span className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] font-semibold text-[#94a3b8]">
            {suffix}
          </span>
        </div>
      ...
      {value && (
        <button
          onClick={() => onChange("")}
          className="text-[11px] text-[#0058be] hover:underline text-left cursor-pointer font-medium mt-1"
        >
          Bỏ lọc khoảng này
        </button>
      )}
...
function SpecFilterInput({
  ...
  if (filter.type === "range") {
    const rangeDef = RANGE_SPEC_DEFS[filter.key] || {
      min: 0,
      max: 10000,
      step: 1,
      suffix: "",
  ...
  return (
    <div
      className="flex flex-col gap-1 max-h-[160px] overflow-y-auto pr-1"
    ...
    >
      ...
      {selected.length > 0 && (
        <button
          onClick={() => onChange("")}
          className="text-[11px] text-[#0058be] hover:underline mt-1 text-left cursor-pointer font-medium"
        >
          Bỏ chọn tất cả
        </button>
      )}
      ...
      try {
        ...
        for (const [key, val] of activeKeys) {
          ...
          if (def?.type === "boolean") {
            ...
            if (!wanted.some((w) => hasRaw.some((h) => matchValue(h, w))))
              return false;
          }
        }
      } catch {
        ...
        <div className="fixed inset-0 z-50 flex lg:hidden">
          ...
          <div className="relative ml-auto w-[300px] bg-white h-full overflow-y-auto p-5 shadow-2xl">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                onClick={() => setMobileSidebarOpen(false)}
                className="p-1.5 rounded-[8px] hover:bg-[#f1f5f9] cursor-pointer"
              >
